...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "btc4coin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"btc4cointools.com", "5.189.155.122"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"btc4cointools.com", "testnet-seed.btc4cointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. btc4coin is probably already running."), addrBind.ToString().c_str());
        else
